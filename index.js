...
function createHttpClient(apiKey) {
  var headers = { 'x-square-api-key': apiKey, 'Content-type': 'application/json' };

  return axios.create({ headers: headers });
}

var GET_STORE = 'store/1_0_0/store/get';
var DISPLAY_CATEGORY = 'catalog/2_0_0/category/display';
var LISTDISPLAY_PRODUCT = 'store/1_0_0/product/listdisplay';
var DISPLAY_PRODUCT = 'store/1_0_0/product/display';
var DISPLAY_RELATEDPRODUCT = 'catalog/1_0_0/relatedproduct/display';
var COORDS_SEARCH = 'store/1_0_0/search/coords';
var ALLSTORESTOCK = 'fulfillment-services/v1/allStoreStock/';
var SUGGEST = 'lm-cross-selling/v1/suggest/';
...
function createUrl(baseUrl, path, pathParams) {
  var url = [baseUrl, path].concat(toConsumableArray(pathParams)).join('/');
  return url;
}

var RemoteApi$1 = function () {
  function RemoteApi(_ref) {
    var _this = this;

    var baseUrlCore = _ref.baseUrlCore,
        baseUrlMS = _ref.baseUrlMS,
        spaceId = _ref.spaceId,
        storeCode = _ref.storeCode,
        apiKey = _ref.apiKey;
    classCallCheck(this, RemoteApi);

    this.fetchCategoryDisplay = function (categoryCode) {
      var url = createUrl(_this.baseUrlCore, DISPLAY_CATEGORY, [categoryCode]);
      return _this.httpGet(url);
    };

    this.fetchProductListDisplay = function (productIdList) {
      var url = createUrl(_this.baseUrlCore, LISTDISPLAY_PRODUCT, [productIdList]);
      return _this.httpGet(url);
    };

    this.fetchProductDisplay = function (productCode) {
      var url = createUrl(_this.baseUrlCore, DISPLAY_PRODUCT, [productCode]);
      return _this.httpGet(url);
    };

    this.fetchRelatedProductDisplay = function (productCode) {
      var url = createUrl(_this.baseUrlCore, DISPLAY_RELATEDPRODUCT, [productCode]);
      return _this.httpGet(url);
    };
    ...
    this.fetchSearchCoords = function (pathParams, queryParams) {
      ...
      var url = createUrl(_this.baseUrlCore, COORDS_SEARCH, [lat, lng]);
      return _this.httpGet(url, queryParams);
    };

    this.fetchAllStoreStock = function (productCode) {
      var url = createUrl(_this.baseUrlMS, ALLSTORESTOCK, [productCode]);
      return _this.httpGet(url);
    };

    this.fetchSuggest = function (productCode) {
      var url = createUrl(_this.baseUrlMS, SUGGEST, [productCode]);
      return _this.httpGet(url);
    };
  ...
  createClass(RemoteApi, [{
    ...
    value: function fetchStore() {
      var url = createUrl(this.baseUrlCore, GET_STORE, [this.storeCode]);
