export const GET_STORE = 'store/1_0_0/store/get';
export const DISPLAY_CATEGORY = 'catalog/2_0_0/category/display';
export const LISTDISPLAY_PRODUCT = 'store/1_0_0/product/listdisplay';
...
export const REAL_TIME_STOCK = 'realtime-stock/v1/v1/realtime-digitalstock';
export const LIST_PRODUCT = 'product-api-v2/v1/listproduct';
export const SHIPPING_PRICE = 'product-api-v2/v1/shippingprice-service';
export const PRODUCT = 'product-api-v2/v1/product';
